...
export const projectTags = websiteSchema.table(
	'project_tags',
	{
...
export const postTags = websiteSchema.table(
	'post_tags',
	{
		postId: uuid('post_id')
			.notNull()
...
export const themes = websiteSchema.table('themes', {
	...
	overlayVignetteOpacity: varchar('overlay_vignette_opacity', { length: 10 })
		.default('0')
		.notNull(),
...
// Fonts table
export const fonts = websiteSchema.table('fonts', {
	id: uuid('id').primaryKey().defaultRandom(),
	name: varchar('name', { length: 255 }).notNull(),
